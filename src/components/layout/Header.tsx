                ...
                <nav className="hidden md:flex items-center space-x-6">
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="space-x-4">
                            <Link to="/login" className="btn bg-primary text-secondary hover:bg-primary-light transition-colors duration-300">Login</Link>
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-secondary py-4">
                    ...
                    {isAuthenticated ? (
                        ...
                        <>
                            <Link to="/login" className="block px-4 py-2 text-primary hover:bg-accent1-light transition-colors duration-300">Login</Link>
